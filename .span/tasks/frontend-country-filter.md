# span Task: Implement Country Selection Component (ID: frontend-country-filter)

## Task Description
Create multi-select country filter in components/CountryDropdown.js
...
**Required tasks:** frontend-scatter-plot
